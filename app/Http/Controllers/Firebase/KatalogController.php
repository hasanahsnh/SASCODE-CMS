...
class KatalogController extends Controller
{
    ...
    function index() {
        ...
        return view('pages.s-katalog', compact('katalogs'));
    ...
    function store(Request $request) {
        ...
        $postData = [
            ...
            'sumber' => $request->sumber_filosofi,
            'gambarUrl' => $gambarUrl,
        ];
        //dd($postData);
    ...
    function edit($id) {
        ...
        if ($editData) {
            return view('pages.katalog', compact('editData', 'key'));
        } else {
    ...
    function downloadDataKatalog()
    {
        ...
        $csvData = "ID, Motif, Filosofi, Sumber\n";
        $images = [];

        foreach ($items as $id => $item) {
            if (is_array($item) && isset($item['motif'], $item['filosofi'], $item['sumber'])) {
                $csvData .= "{$id}, " . implode(", ", [
                    $item['motif'],
                    $item['filosofi'],
                    $item['sumber'],

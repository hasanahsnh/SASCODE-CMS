                  ...
                  <table class="table table-hover w-100">
                    <thead>
                      <tr>
                        <th>Lihat</th>
                        <th>Nama Motif</th>
                        <th>Filosofi Motif</th>
                        <th>Sumber Filosofi</th>
                        <th>Gambar Motif</th>
                        <th>QR Code</th>
                        <th>Action</th>
                      </tr>
                    ...
                    <tbody>
                                      ...
                                      <div class="card-body">
                                        ...
                                        <form class="forms-sample" id="formEdit{{ $key }}" action="{{ route('update-motif', ['id' => $key]) }}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['motif'] }}" id="nama_motif" name="nama_motif" placeholder="Nama motif" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Filosofi Motif</label>
                                            <div class="col-sm-9">
                                              <textarea class="form-control" id="filosofi_motif" name="filosofi_motif" placeholder="Filosofi motif" required>{{ $item['filosofi'] }}</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputMobile" class="col-sm-3 col-form-label">Sumber Filosofi</label>
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['sumber'] }}" id="sumber_filosofi" name="sumber_filosofi" placeholder="Mobile number" required>
                                              <div class="note" style="color: gray; font-size:11px; padding-top: 5px;">
                                                <strong>Format penulisan sumber:</strong> [Penulis], [Judul buku], [Tahun terbit], [ISBN], [Penerbit].
                                              </div>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                              <input type="file" class="form-control" value="{{ $item['gambarUrl'] }}" id="gambar_motif" name="gambar_motif" placeholder="Pilih gambar">
                                            </div>
                                          </div>
                                      ...
                                      <div class="card-body">
                                        ...
                                        <form class="forms-sample" id="formEdit{{ $key }}" action="" method="">
                                          ...
                                          <div class="form-group row">
                                            <label for="exampleInputMobile" class="col-sm-3 col-form-label">Sumber Filosofi</label>
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['sumber'] }}" id="sumber_filosofi" name="sumber_filosofi" placeholder="Mobile number" readonly>
                                              <div class="note" style="color: gray; font-size:11px; padding-top: 5px;">
                                                <strong>Format penulisan sumber:</strong> [Penulis], [Judul buku], [Tahun terbit], [ISBN], [Penerbit].
                                              </div>
                                            </div>
                                          ...
                                          <div class="form-group row">
                                            <label for="exampleInputMobile" class="col-sm-3 col-form-label">Gambar Motif</label>
                                            <div class="col-sm-9">
                                              <img src="{{ $item['gambarUrl'] }}" alt="Preview Foto Toko" style="max-width: 50%; height: auto; margin-bottom: 10px;">
                                            </div>
                                          </div>
                                          <div class="form-group row">
                      ...
                      @else
                        <tr>
                          <td colspan="5" style="text-align: center">Data katalog tidak ditemukan</td>
                        </tr>
                      @endif
                    </tbody>
                  </table>
                            ...
                            <div class="card-body">
                              ...
                              <form class="forms-sample" id="formTambah" action="{{ url('simpan-motif') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama Motif</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama_motif" name="nama_motif" placeholder="Nama motif" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Filosofi Motif</label>
                                  <div class="col-sm-9">
                                    <textarea class="form-control" id="filosofi_motif" name="filosofi_motif" rows="4" placeholder="Filosofi motif" required></textarea>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputMobile" class="col-sm-3 col-form-label">Sumber Filosofi</label>
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="sumber_filosofi" name="sumber_filosofi" placeholder="Sumber filosofi" required>
                                    <div class="note" style="color: gray; font-size:11px; padding-top: 5px;">
                                      <strong>Format penulisan sumber:</strong> [Penulis], [Judul buku], [Tahun terbit], [ISBN], [Penerbit].
                                    </div>
                                  </div>
                                ...
                                <div class="form-group row">
                                  <label for="exampleInputMobile" class="col-sm-3 col-form-label">Gambar Motif</label>
                                  <div class="col-sm-9">
                                    <input type="file" class="form-control" id="gambar_motif" name="gambar_motif" placeholder="Pilih gambar" required>
                                  </div>
                                </div>

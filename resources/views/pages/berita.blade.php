                                      ...
                                      <div class="card-body">
                                        ...
                                        <form class="forms-sample" id="formEdit{{ $key }}" action="{{ route('update-berita', ['id' => $key]) }}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['judulArtikel'] }}" id="judul_artikel" name="judul_artikel" placeholder="Judul artikel" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Jurnalis</label>
                                            <div class="col-sm-9">
                                              <input type="text" class="form-control" value="{{ $item['jurnalis'] }}" id="jurnalis" name="jurnalis" placeholder="Jurnalis" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Konten Berita</label>
                                            <div class="col-sm-9">
                                              <textarea class="form-control" id="konten_berita" name="konten_berita" placeholder="Konten berita" required>{{ $item['kontenBerita'] }}</textarea>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Tanggal Terbit</label>
                                            <div class="col-sm-9">
                                              <input type="date" class="form-control" value="{{ $item['tanggalTerbit'] }}" id="tanggal_terbit" name="tanggal_terbit" placeholder="Masukkan tanggal terbit" required>
                                            </div>
                                          </div>
                                          <div class="form-group row">
                                            <label for="exampleInputMobile" class="col-sm-3 col-form-label">Foto Berita</label>
                                            <div class="col-sm-9">
                                              <input type="file" class="form-control" value="{{ $item['fotoBeritaUrl'] }}" id="foto_berita" name="foto_berita" placeholder="Pilih foto">
                                            </div>
                                          </div>
                            ...
                            <div class="card-body">
                              ...
                              <form class="forms-sample" id="formTambah" action="{{ url('simpan-berita') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="jurnalis" name="jurnalis" placeholder="Jurnalis" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Konten Berita</label>
                                  <div class="col-sm-9">
                                    <textarea class="form-control" id="konten_berita" name="konten_berita" rows="4" placeholder="Konten berita" required></textarea>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Tanggal Terbit</label>
                                  <div class="col-sm-9">
                                    <input type="date" class="form-control" id="tanggal_terbit" name="tanggal_terbit" placeholder="Masukkan tanggal terbit" required>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="exampleInputMobile" class="col-sm-3 col-form-label">Foto Berita</label>
                                  <div class="col-sm-9">
                                    <input type="file" class="form-control" id="foto_berita" name="foto_berita" placeholder="Pilih Foto" required>
                                  </div>
                                </div>
